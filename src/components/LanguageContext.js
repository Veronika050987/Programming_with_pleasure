...
const translations = 
{
    ru: 
    {
        ...
        about_lemour: "Программирование учит нас видеть, как лемур, - замечать мельчайшие баги в темноте кода, широко раскрывать глаза от восторга при виде идеального решения-мотылька и ловко прыгать по веткам в Git.",
        ...
        game_race_desc: "Управляй роутером и браузером, чтобы собрать страницу перед тем, как истечет таймер",
        game_quiz_title: "Квиз в стихах",
        game_quiz_desc: "Ответь на вопросы квиза",
        game_sql_garage: "SQL гараж",
        game_sql_garage_desc: "Создание и управляние SQL гаражом",
        ...
        game_webka: "Детектив Вебка и потерянная машинка",
        game_webka_desc: "Помоги детективу Вебке найти потерянную машинку",
        game_webka_key: "Детектив Вебка и потерянные ключи",
        game_webka_key_desc: "Помоги детективу Вебке найти потерянные ключи",
        game_webka_address: "Детектив Вебка и путь к другу",
        game_webka_address_desc: "Помоги детективу Вебке найти дорогу к другу Сшарпика",
        homepage: "На главную",
    ...
    en:
    {
        ...
        about_lemour: "Programming teaches us to see like a lemur - to spot the smallest bugs in dark code, to widen our eyes with wonder upon catching the perfect moth-solution and to leap deftly from one Git branch to another.",
        ...
        game_webka: "Webka detective and the lost car",
        game_webka_desc: "Help Webka detective to find the lost car",
        game_webka_key: "Webka detective and the lost key",
        game_webka_key_desc: "Help Webka detective to find the lost key",
        game_webka_address: "Webka detective and the way to friend",
        game_webka_address_desc: "Help Webka detective to find the road to Csharpik friend",
        homepage: "Home page",
